...
class UUIDSetStore:
    def __init__(self, filename: str = "download_info.pkl", flush_interval: int = 2) -> None:
        lock_dir: str = os.path.join(os.getcwd(), "lock")
        os.makedirs(lock_dir, exist_ok=True)

        self.filename: str = os.path.join(lock_dir, filename)
