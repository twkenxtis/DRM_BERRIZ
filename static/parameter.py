...
from typing import Callable, Any, Dict, Optional, TypeVar, Union, Type

# 定義一個 TypeVar 來表示被裝飾函式的型別，以保留原始簽名資訊
...
class ParamStore:
    ...
    # all 方法的型別註釋，回傳一個副本 (Dict[str, Any])
    def all(self) -> Dict[str, Any]:
        return dict(self._store)

# 實例化 ParamStore，使其成為單例物件
