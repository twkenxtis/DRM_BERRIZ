...
class Berriz_cookie:
    ...
    def load_cookies(self) -> None:
        file_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), r"cookies\\bz_a.txt")
        ...
        self._cookies = {
            "_T_ANO": (
                "SYTYXuorgrmvu/ZEGP71JTaTg3yiuG4sZxaOeozx78HQ0A7uquEdvGymQMpOj7v32hnMu4ic/"
                "cIQwnnQFk1i9aG1MqdJuY19Z1at6Ug2JcQmMaClRTlDiXUGQKiGqVDgYpz6RSKPVWCAggMnFg0o"
                "UO7cqKmwXNno1bMGAYssWBFmKy14B8tm6vrXNZgYjPUB5i2OrKE7NG9oPMleSG9TmM7Nx+uEqs28+"
                "FWmuIv0idAn+SIhD2oJkZl+8DDxY3YybE4qDKXw55CebkK/OZkjPO1CrPmZ+99TIXN7S/7jx7ZDY/"
                "QVAHZKAUcz/1YdgDQ7zS2Hj8SvsRmi2wL5v5xbNA=="
            ),
            "pacode": "fanplatf::app:ios:phone:",
            "pcid": "AB0FABCB-9CE5-4D0A-B7C2-A5DD30BA3B8E",
            "__T_": "1",
